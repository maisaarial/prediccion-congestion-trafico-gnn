...
def main():
    ...
    results_dir = Path("results") / "experimentos_descongestion_mape" / run_id
    ...
    gen_cmd = [
        sys.executable,
        "scripts/generar_datasets_descongestion.py",
        "--casos",
        *args.casos,
        "--adyacencias",
        *args.adyacencias,
    ...
    train_cmd = [
        sys.executable,
        "scripts/probar_epocas_datos_descongestion.py",
        "--data_dir",
        "data/processed_descongestion",
        "--output_dir",
        str(results_dir),
        "--casos",
        *casos_entrenamiento,
